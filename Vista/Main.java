...
public class Main {
    public static void main(String[] args) {
        Scanner entrada = new Scanner(System.in);
        	Elcontrolador VariableControl = new Elcontrolador();
        String opcion = "";
        ...
        while (!opcion.equals("15")) {
            ...
            if (opcion.equals("1")) {
                ...
                if (VariableControl.ConsultarDepartamento().equalsIgnoreCase(nombreActual)) {
                    ...
                    System.out.println("El nombre ingresado no coincide con el departamento que se encuentra registrado.");
                }
                ...
                System.out.print("Ingrese el tipo de documento (CC, TI): ");
                ...
                if (registrado) {
                    System.out.println("El estudiante ha sido registrado .");
                } else {
                ...
                System.out.print("Ingrese tipo de documento (CC, TI): ");
                ...
                if (estudiante != null) {
                    ...
                    System.out.println("No se encontró registro de un estudiante con esos datos.");
                }
            } else if (opcion.equals("5")) {
                // Modificar estudiante del departamento

                System.out.println("Modificar estudiante en el departamento:");
                System.out.print("Ingrese tipo de documento (CC, TI): ");
                String tipo = entrada.nextLine();
                System.out.print("Ingrese número de documento registrado: ");
                ...
                System.out.print("Ingrese nuevo tipo de documento: ");
                String nuevotipo = entrada.nextLine();
                

                boolean modificado = VariableControl.modificarEstudianteDepartamento(tipo,nuevotipo, numeroActual, nuevoNumero);
                if (modificado) {
                    ...
                    for (Estudiante estudiante : estudiantes) {
                        ...
                        switch (estadoInput) {
                            case "P":
                                ...
                                break;
                            case "R":
                                estado = Asistencia.Estado.RETARDO;  // Cambio de ausente a retardo 
                                break;
                            case "A":
                            default:
